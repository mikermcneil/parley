...
function Deferred(handleExec){
  ...
  // Start the 15 second .exec() countdown.
  var omen = this._omen;
  this._execCountdown = setTimeout(function(){
    ...
    console.warn(
      '- - - - - - - - - - - - - - - - - - - - - - - - - - - - - -\n'+
      'WARNING: Something seems a little off with this usage.\n'+
      'Despite being initially called over 15 seconds ago, this\n'+
      'function has still not actually been executed.\n'+
      '\n'+
      '(Any chance this code is missing an "await"?)\n'+
      (omen?(
        '\n'+
        'To assist you in hunting this down, here is a stack trace:\n'+
        '```\n'+
        flaverr.getBareTrace(omen)+'\n'+
        '```\n'+
        '\n'
      ):'')+
