...
Deferred.prototype.exec = function(_cb, handleUncaughtException){
  ...
  cb = function _tryToRunCb(/*…*/) {
    ...
    return proceedAfterRunningUserlandLCs(self, _cb, errCbArg, resultCbArg, extraCbArgs, handleUncaughtException);
...
function proceedAfterRunningUserlandLCs(self, _cb, errCbArg, resultCbArg, extraCbArgs, handleUncaughtException) {
