 ...
 *         thrown from within `cb`. **But REMEMBER: this will not handle uncaught exceptions
 *         from any OTHER asynchronous callbacks which might happen to be used within `cb`.**
 ...
 * ```
 */
Deferred.prototype.exec = function(cb, handleUncaughtException){
