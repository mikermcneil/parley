...
Deferred.prototype.exec = function(_cb, handleUncaughtException){
  ...
  // - - - - - - - - - - - - - - - - - - - - -
  // TODO: add AsyncFunction check
  // - - - - - - - - - - - - - - - - - - - - -

  // Wrap the executioner in a `try` block to prevent common issues from uncaught exceptions.
  // (Remember: This only works at the top level!)
  try {
