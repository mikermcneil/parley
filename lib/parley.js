...
module.exports = function parley(handleExec, explicitCbMaybe, customMethods, timeout, omen, interceptBuiltInError){
  ...
  // TODO: ascii (when I'm back in a country that actually lets me install NPM packages using a proper SSL certificate)
  if (interceptBuiltInError) {
    // TODO: Actually implement `interceptBuiltInError`
