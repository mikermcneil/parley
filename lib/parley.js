...
module.exports = function parley(handleExec, explicitCbMaybe){
  ...
  var moreMethods = { pretend: function(x,y){ this._i = this._i || 0; this._i++; console.log(this._i, x, y); return this; } };
  // TODO: make this configurable instead of just being fake
  if (moreMethods) {
    ...
    for (var methodName in moreMethods) {
      if (methodName === 'exec' || methodName === 'then' || methodName === 'catch' || methodName === 'toPromise') {
