...
module.exports = function parley(handleExec, explicitCbMaybe){
  ...
  var π = {
    ...
    _hasFinishedExecuting: undefined,
    ...
    exec: function (cb){
      ...
      // Spinlock
      if (π._hasBegunExecuting) {
        console.warn(
          '\n'+
          'That\'s odd... It looks like '+(codeName ? codeName+'()' : 'this Deferred')+' '+
          'has already '+(π._hasFinishedExecuting?'finished':'begun')+' executing.\n'+
