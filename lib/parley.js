...
module.exports = function parley(handleExec, explicitCbMaybe){
  ...
  if (explicitCbMaybe) {
    ...
    // Note that we set the hasBegunExecuting flag here regardless.
    // (this is to protect accidents that could happen when userland code actually attempts to use .exec())
